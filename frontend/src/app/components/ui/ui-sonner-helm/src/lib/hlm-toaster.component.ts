...
export class HlmToasterComponent {
	...
	toastOptions = input<ToasterProps['toastOptions']>({
		classes: {
			toast:
				'group toast group-[.toaster]:bg-foreground group-[.toaster]:text- group-[.toaster]:border-border group-[.toaster]:shadow-lg',
			description: 'group-[.toast]:text-',
			actionButton: 'group-[.toast]:bg-primary group-[.toast]:text-',
			cancelButton: 'group-[.toast]:bg-muted group-[.toast]:text-',
		},
	});
